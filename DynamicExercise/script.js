let water = 'url("https://www.verywellfit.com/thmb/G_PLH6g6WFNoNbyCYOAmnt1HEUY=/1500x1000/filters:fill(FFDB5D,1)/Verywell-42-3498282-Pushup01-1596-5994a0f8519de20010b3bdd3.gif")';
    ...
    let jumpTucks =
      'url("https://img.grouponcdn.com/seocms/3XWKbnvhVk52DkXCns1ReSNpJMbb/Knee_Tuck_Jump_gif-600x600")';
    let russainTwist =
      'url("https://www.gymguider.com/wp-content/uploads/2020/03/russian-twist.gif")';
    let wallSit =
      'url("https://th.bing.com/th/id/OIP.dDleqGehjKO5DdJAsm5aXAHaEK?pid=ImgDet&rs=1")';
    let jumpSquat =
    ...
    let jumpLunge =
      'url("https://mystylemyanmar.com/wp-content/uploads/2020/10/jumping-lunge-PopSugar.gif")';
